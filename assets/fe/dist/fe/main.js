...
/* harmony import */ var _components_marker_marker_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./components/marker/marker.component */ "./src/app/components/marker/marker.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _components_marker_marker_component__WEBPACK_IMPORTED_MODULE_22__["MarkerComponent"],
            ],
            imports: [
...
/* harmony import */ var _components_containers_scrumboard_scrumboard_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/containers/scrumboard/scrumboard.component */ "./src/app/components/containers/scrumboard/scrumboard.component.ts");
/* harmony import */ var _components_containers_issueboard_issueboard_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/containers/issueboard/issueboard.component */ "./src/app/components/containers/issueboard/issueboard.component.ts");
...
var HOME_STATE = [
    {
        name: 'scrumboard',
        url: '/',
        views: Object(_utils_layouts_utils__WEBPACK_IMPORTED_MODULE_0__["ContentOnly"])(_components_containers_scrumboard_scrumboard_component__WEBPACK_IMPORTED_MODULE_1__["ScrumboardComponent"]),
    }
];
var ISSUES_STATE = [
    {
        name: 'issuesboard',
        url: '/issues',
        views: Object(_utils_layouts_utils__WEBPACK_IMPORTED_MODULE_0__["ContentOnly"])(_components_containers_issueboard_issueboard_component__WEBPACK_IMPORTED_MODULE_2__["IssueboardComponent"]),
    }
];
...
var IssueboardComponent = /** @class */ (function () {
    ...
    IssueboardComponent.prototype.updateStatus = function (id, status) {
        this.http.post(Object(app_constants_endpoints__WEBPACK_IMPORTED_MODULE_4__["UPDATE_ISSUE_STATUS"])(id), { "status": status })
            .subscribe();
    ...
    IssueboardComponent.prototype.updateDeadline = function (id, deadline) {
        if (deadline) {
            this.http.post(Object(app_constants_endpoints__WEBPACK_IMPORTED_MODULE_4__["UPDATE_ISSUE_DEADLINE"])(id), { "deadline": deadline })
                .subscribe();
        }
    };
...
/* harmony import */ var _uirouter_angular__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @uirouter/angular */ "./node_modules/@uirouter/angular/lib/index.js");
/* harmony import */ var app_constants_endpoints__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! app/constants/endpoints */ "./src/app/constants/endpoints.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ScrumboardComponent = /** @class */ (function () {
    function ScrumboardComponent(http, filterService, searchService, dataService, stateService) {
        this.http = http;
        ...
        this.filter_wip = true;
        this.filter_hours = true;
        this.filter_pending = true;
        this.filter_resolved = false;
    ...
    ScrumboardComponent.prototype.getIssue = function (id) {
        this.filtered_scrum = [this.scrums.find(function (scrum) {
    ...
    ScrumboardComponent.prototype.updateStatus = function (id, status) {
        this.http.post(Object(app_constants_endpoints__WEBPACK_IMPORTED_MODULE_6__["UPDATE_ISSUE_STATUS"])(id), { "status": status })
            .subscribe();
        var index = this.issues.findIndex(function (issue) {
            return issue.id == id;
        });
        this.issues[index].status = status;
        var group_index = this.scrums.findIndex(function (scrum) {
        ...
        var scrum_index = this.scrums[group_index].scrums.findIndex(function (scrum) {
            return scrum.issue_logs.find(function (issue) {
                return issue.id == id;
            });
        });
        var issue_index = this.scrums[group_index].scrums[scrum_index].issue_logs.findIndex(function (issue) {
            return issue.id == id;
        });
    ...
    ScrumboardComponent.prototype.updateDeadline = function (id, deadline) {
        if (deadline) {
            this.http.post(Object(app_constants_endpoints__WEBPACK_IMPORTED_MODULE_6__["UPDATE_ISSUE_DEADLINE"])(id), { "deadline": deadline })
                .subscribe();
        }
    };
...
/*!****************************************!*\
  !*** ./src/app/constants/endpoints.ts ***!
  \****************************************/
/*! exports provided: GET_LOGS, GET_ISSUES, GET_TEAM_MEMBERS, GET_TEAM_PROJECTS, UPDATE_ISSUE_STATUS, UPDATE_ISSUE_DEADLINE */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
